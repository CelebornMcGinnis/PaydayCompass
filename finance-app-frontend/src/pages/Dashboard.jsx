...
import { accountsApi, sharingApi, peerNotificationsApi, divisionsApi, paydayApi, ApiError } from "../lib/apiClient";
  ...
  return (
    <div className="min-h-screen pb-24" style={{ background: colors.bg, fontFamily: fontBody }}>
      <div className="sticky top-0 z-30 flex items-center justify-between px-5 transition-all" style={{ paddingTop: scrolled ? 10 : 16, paddingBottom: scrolled ? 10 : 16, background: colors.bgTranslucent, backdropFilter: "blur(8px)", borderBottom: `1px solid ${colors.border}` }}>
        <div className="flex items-center gap-2">
          {isDesktop ? (
            <img src={theme === "dark" ? "/ledgerline-logo-dark.png" : "/ledgerline-logo-light.png"} alt="Ledgerline" style={{ width: scrolled ? 130 : 190, height: "auto", transition: "width 0.2s ease" }} />
          ) : (
            <>
              <img src={theme === "dark" ? "/ledgerline-favicon-dark.png" : "/ledgerline-favicon-light.png"} alt="" style={{ width: 22, height: 22 }} />
      ...
      <div className="px-5 pt-6 max-w-md mx-auto">
        ...
        <div ref={quickActionsRef} className="grid grid-cols-3 gap-2 mb-8">
