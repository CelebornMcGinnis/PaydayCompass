    ...
    with transactions_table.batch_writer() as batch:
        for split in splits:
            ...
            item = {
                ...
                "amount": decimal.Decimal(str(split["amount"])),
...
def _transfer(user_id, body):
    ...
    # aggregation logic (users aren't expected to set a budget for it) -
    # moving money between your own accounts shouldn't count as spending.
    out_item = {
    ...
    return _response(201, {"transferId": transfer_id, "out": out_item, "in": in_item}, default=_decimal_default)
